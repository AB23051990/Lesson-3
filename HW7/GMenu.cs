    ...
    internal class GMenu
    {
        ...
        {            
            string[] items = {
                ...
                "Задание 5   - [Создать класс рациональных чисел]",
                "Задание 6   - [Для класса банковский счет переопределить операторы == и !=]",
                "Задание 7   - [Определить интерфейс IСoder..]",
                "Выход" };            
            method[] methods = new method[] { Lesson1, Lesson2, Lesson3, Lesson4, Lesson5, Lesson6, Lesson7, Lesson8, Lesson9, Lesson10, Exit };
        ...
        internal static void Lesson8()//"Задание 5"
        {
            RationalNumbers.PrintRationalNumbers();
        }
        internal static void Lesson9()//"Задание 6"
        {
            BankAccountConstructor3.PrintRationalNumbers();
        }
        internal static void Lesson10()//"Задание 6"
        {
            ACoder.Print();
        }
