...
namespace HW3
{
    ...
    internal class BankAccountConstructor2
    {
        ...
        internal double AccountNumber { get => _AccountNumber; set => _AccountNumber = value; }
        internal double Balance { get => _Balance; set => _Balance = value; }
        internal double NewAccountNumber { get => _NewAccountNumber; set => _NewAccountNumber = value; }
        internal double NewBalance { get => _NewBalance; set => _NewBalance = value; }
        ...
        internal static void MainBankAccountConstructor2()
        {
            ...
            while (true)
            {
                ...
                double take_off = int.Parse(type);                
                if (check.Balance <= 0)
                {
